...
var slider = $('#slider'); //almacenar botones y se guarda en variables 

var siguiente = $('#btn-next');
var anterior = $('#btn-prev'); //mover ultima imagen al primer lugar 
// seleccionamos la ultmia imagen y  sucecivamente  se repetira 

$('#slider .slider__section:last').insertBefore('#slider .slider__section:first'); //mostrar la primera imagen con un margen de -100%
// aplicamos un estilo para ver el margen menos de 100%

slider.css('margin-left', '-' + 100 + '%'); // funcion mover  a la derecha 

function moverD() {
  //escogemos el estilo de css de cual queremos mover con tiempo 
  slider.animate({
    marginLeft: '-' + 200 + '%'
  }, 700, //la funcion se ejecuta cuando termine la ejecucion y se ejecuta esta funcion
...
autoplay();
/*este codio es de la valoraciones */
